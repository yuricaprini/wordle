...
class BasicHttpCodec {
    ...
    switch (decodeState) {
      ...
      case BODY:
        ...
        if (bodyLength == 0) {
          ...
          String contentLength = basicHttpMessage.getHeaderValue(BasicHttpMessage.CONTENT_LEN_KEY);
          String contentType = basicHttpMessage.getHeaderValue(BasicHttpMessage.CONTENT_TYPE_KEY);
   ...
   */
  public void encode(BasicHttpMessage httpMessage, OutputQueue outputQueue) {
